...
void LeftMotor_Forward(int rate)
{
    //左轮   P2.7 and P2.4
      ...
      TIMER_A0->CCR[1] = (rate)*RATE1/RATE2*PIAN1/PIAN2;///////////////////////////////////
...
void RightMotor_Forward(int rate)
{
    //右轮   P5.6 and P2.6
      ...
      TIMER_A0->CCR[3] = rate*RATE1/RATE2;
      TIMER_A0->CTL = TASSEL_1+MC_1+TACLR;
      P5->SEL0 &= ~BIT6;
      P5->SEL1 &= ~BIT6;
      P5->DIR |= BIT6;
...
void LeftMotor_Backward(int rate)
{
    //左轮   P2.7 and P2.4
      ...
      TIMER_A0->CCR[4] = rate*RATE1/RATE2;
      TIMER_A0->CTL = TASSEL_1+MC_1+TACLR;
      P2->SEL0 &= ~BIT4;
      P2->SEL1 &= ~BIT4;
      P2->DIR |= BIT4;
...
void RightMotor_Backward(int rate)
{
    //右轮   P5.6 and P2.6
      ...
      TIMER_A2->CCR[1] = rate*RATE1/RATE2;
...
{
  //计算每个电机的速度
  left_motor_speed = 15 - PID_value;///////////10
  right_motor_speed =15 + PID_value;///////////10
  motor_step(left_motor_speed, right_motor_speed,0,0);///////0,,0
}
